/*
*   Senne.Scheepers@student.pxl.be
*/
...
function loaded() {
    ...
    console.log(buttonGetPersonName);
...
function handlePutPerson() {
    let url = 'http://localhost:3000/persons/';
    let output = document.getElementById("div_output");
    let id = document.getElementById("txt_put_id").value;
    let name = document.getElementById("txt_put_name").value;
    let person = {name: name};
    makeElementEmpty(output);
    fetch(url + id,
        {
